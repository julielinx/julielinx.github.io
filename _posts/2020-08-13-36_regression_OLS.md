...
The notebook where I did my code for this entry can be found on my github page in the [Entry 36 notebook](https://github.com/julielinx/datascience_diaries/blob/master/03_supervised_learning/01_regression/36a_nb_regression.ipynb).
